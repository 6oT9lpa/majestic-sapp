...
`Majestic SAPP` — backend-платформа на `FastAPI` для обработки обращений пользователей: заявок на помощь, жалоб, амнистий, действий модераторов, отчётности и административного контроля.
